...
def parse_assign_order(sentence: str, game_state: GameState, player_id: str) -> Optional[AssignOrder]:
    ...
    # rather than a count of unnamed units. An assigned character
    ...
    # 10 soldiers and Doctor McCoy to Alan Reed"): the count fills the
    ...
    if match:
        ...
        for name in [n.strip() for n in subject_text.split(' and ') if n.strip()]:
            ...
            # McCoy to Alan Reed". One kind fills the transfer; the splitter
            ...
            # over whatever the donor holds: `it` refers to
    ...
    # form. "Have <character> give me 50 gold" and "Give <character> 10 gold"
