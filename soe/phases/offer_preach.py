...
from soe.phases.units import _add_group_units
...
def _offer_acceptance_threshold(target: Character, game_state: GameState) -> float:
    ...
    highest skill plus the value of items in their possession (the design)."""
...
def _transfer_ownership(target: Character, new_faction_id: str, game_state: GameState) -> None:
    ...
    to the new faction: the character, and everyone and everything currently
    assigned to them, come under the offering player's control."""
