...
from soe.config import population_band_for
from soe.models import WorldMap, City, Road, PopulationBand, RoadQuality
...
def create_sample_map() -> WorldMap:
    ...
    # Layout and mileages stay in step with maps/starter_map.json: west→east
