...
def process_combat(orders_by_player: Dict[str, List[Order]], game_state: GameState,
    ...
    # not where they stood when the order was read. "Go to Kitesta and attack
    # Aurelia" is parsed while the character is still in Riverton, and movement
    ...
    for city_id, attacks in attacks_by_location.items():
        ...
        for attacker_player_id, attack_order in attacks:
            ...
            # rules.md, ATTACK: "If John May is not present, then no attack
            # will take place."
            #
            ...
            # "lost" a battle to the soldiers she had left behind in Kitesta,
